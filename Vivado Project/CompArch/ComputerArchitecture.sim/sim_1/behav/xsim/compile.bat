...
REM
REM Generated by Vivado on Mon Dec 29 04:27:27 +0200 2025
...
echo "xvlog --incr --relax -prj TestBench1_tb_vlog.prj"
call xvlog  --incr --relax -prj TestBench1_tb_vlog.prj -log xvlog.log
