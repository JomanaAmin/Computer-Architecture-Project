...
#
# Script generated by Vivado on Mon Dec 29 04:30:20 +0200 2025
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TestBench1_tb.sh
...
#
# Usage        : TestBench1_tb.sh
#                TestBench1_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TestBench1_tb.sh [-rerun]
#                TestBench1_tb.sh [-reset_run]
#                TestBench1_tb.sh [-clean]
#                TestBench1_tb.sh [-reset_log]
#                TestBench1_tb.sh [-help]
#
...
# script info
echo -e "TestBench1_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TestBench1_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TestBench1_tb xil_defaultlib.TestBench1_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TestBench1_tb -key {Behavioral:sim_1:Functional:TestBench1_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TestBench1_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TestBench1_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TestBench1_tb.sh [-help]\n\
Usage: TestBench1_tb.sh [-step]\n\
Usage: TestBench1_tb.sh [-lib_map_path]\n\
Usage: TestBench1_tb.sh [-rerun]\n\
Usage: TestBench1_tb.sh [-reset_run]\n\
Usage: TestBench1_tb.sh [-clean]\n\
Usage: TestBench1_tb.sh [-reset_log]\n\
Usage: TestBench1_tb.sh [-keep_index]\n\
Usage: TestBench1_tb.sh [-noclean_files]\n\n\
